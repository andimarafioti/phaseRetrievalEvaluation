...
load('convergence_fgla_timed_ljspeech.mat')

plotTimedConvergence(3, mean(ODG_gla(2:end, :, :), 1), red, timed_gla, 'ODG', [-3,0.5])
plotTimedConvergence(4, -mean(SC_gla(2:end, :, :), 1), red, timed_gla, 'SNR_{MS}', [5,50])
